...
I've not included/removed a number of test images and data, so if you want this to generate functional pages, you'll need to edit the html forms, or put in your own images.


REQUIREMENTS:
python3, sqlite, bash (right now this looks for /bin/bash).
